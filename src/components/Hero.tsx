                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight">
                            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                                A maquininha perfeita
                            </span>
                            <br />
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-purple-300 via-white/90 to-pink-300"
                                )}
                            >
                                para o seu negócio
                            </span>
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/50 mb-10 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
                            Taxas justas, dinheiro na conta em 1 dia e o melhor suporte do Brasil. Junte-se a milhares de empreendedores de sucesso.
                        </p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                         <a href="#solutions" className="bg-primary hover:bg-pink-700 transition-all duration-300 text-white font-bold py-4 px-8 rounded-full text-lg inline-block">
                            Peça já a sua
                        </a>
                    </motion.div>
                </div>
